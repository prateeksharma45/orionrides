    ...
    return (
        <>
            ...
            <motion.div
                ...
                {
                    loading ? (
                        <div className="vehicle-details-loader">
                            <div className="vehicle-details-image-loader"></div>
                            <div className="vehicle-info-loader">
                                <div className="vehicle-info-text-loader"></div>
                                <div className="vehicle-info-text-loader"></div>
                                <div className="vehicle-info-text-loader"></div>
                                <div className="vehicle-info-text-loader"></div>
                                <div className="vehicle-info-text-loader"></div>
                                <div className="vehicle-info-button-loader"></div>
                            </div>
                        </div>
                    ) : (
